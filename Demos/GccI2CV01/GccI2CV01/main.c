...
int main(void)
{
    ...
    while (1) 
    {
        ...
        // sprintf(offsetString2, "Offset: %d", state);
        // SSD1306_StringXY(0, 0, offsetString2);
        //  Display the distance as 10.00 cm
        sprintf(distance, "Distance: %u.%u cm", _Distance/10, _Distance%10);
